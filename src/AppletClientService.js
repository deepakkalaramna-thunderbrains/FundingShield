...
class AppletClientService {
    ...
    registerAppActionListener() {
        this.appActionDetails.forEach(appActionDetail => {
            this.ffAAppletClient.on(appActionDetail.actionName, this.onAppActionClicked.bind(this, appActionDetail));
        });
        // this.navigateToApplet(this.appActionDetails[1]);
    }

    showSnackBar(message,error) {
        document.querySelector(ComponentConstant.SNACK_BAR).showSnackBar(message,error);
    }
